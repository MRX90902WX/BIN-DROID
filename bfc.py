...
#Code Modificado : D3M0-H@CK
#Made in Ecuador : $%$%$%%$%%%

print("\033[1;31m——————————————————————————————————————")
bin_format = input("╽_\033[1;32m[=]Ingrese un Bin: ")
print("\033[1;31m|")
mes = input("╽_\033[1;32m[=]Ingrese mes (ej.5): ")
print("\033[1;31m|")
año = input("╽_\033[1;32m[=]Ingrese año (ej.28): ")
print("\033[1;31m|")
cantidad = input("╽_\033[1;32m[=]Cantidad: ")
print("\033[1;31m|")
print("|   ————————-———————————")
...
def main():
  for i in range(int(cantidad)):                
    ...
    print(f"\033[1;31m|\033[1;37m{cc}\033[1;31m| \033[1;31m|\033[1;37m{mes}/{año}\033[1;31m| \033[1;31m|\033[1;37m{ccv_gen()}\033[1;31m|")
main()
